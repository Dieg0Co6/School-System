...
export default function TablaAlumnoCrud({selectAll, handleSelectAll, requestSort, sortConfig, loading, currentAlumnos, selectedAlumnos, handleSelectAlumno, formatDate, abrirModalEditarAlumno, abrirModalEliminarAlumno }) {
    return (
